...
wocstr.homotopy_origin=Suffix(direction=Suffix.EXPORT, datatype=Suffix.FLOAT)
wocstr.homotopy_origin.set_value(wocstr.Fb, 4)  #
wocstr.homotopy_origin.set_value(wocstr.Tr, 90)  #
wocstr.homotopy_destination=Suffix(direction=Suffix.EXPORT, datatype=Suffix.FLOAT)
wocstr.homotopy_destination.set_value(wocstr.Fb, 5)  #
wocstr.homotopy_destination.set_value(wocstr.Tr, 100)  #
